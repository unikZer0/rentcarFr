...
<div class="row">
  <div class="col-md-4 stretch-card grid-margin">
      <div class="card bg-gradient-danger card-img-holder text-white">
          <div class="card-body">
              <h4 class="font-weight-normal mb-3">Order total<i class="mdi mdi-chart-line mdi-24px float-end"></i></h4>
          ...
          <div class="card-body">
              ...
              @else
                  @foreach($salesPerMonth as $sales)
                      ...
                      <h2>{{ number_format($sales->total_sales, 3) }} KIP</h2>
                  @endforeach
              @endif
          </div>
      </div>
  ...
  <div class="col-md-4 stretch-card grid-margin">
      <div class="card bg-gradient-success card-img-holder text-white">
          <div class="card-body">
              <h4 class="font-weight-normal mb-3">Year income <i class="mdi mdi-diamond mdi-24px float-end"></i></h4>
